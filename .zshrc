...
alias sshdbzp='ssh -i ~/.ssh/common-service-beta.pem ec2-user@query.beta.deermobility.com'
alias sshdpzp='ssh -i ~/.ssh/devops-prod.pem ec2-user@query.deermobility.com'
